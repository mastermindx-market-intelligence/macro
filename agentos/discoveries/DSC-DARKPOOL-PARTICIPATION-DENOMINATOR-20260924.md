...
falsifier: Rebuild the original engine/builder against the reproduced source dates and show that every FINRA-facility-volume / consolidated-volume observation is in (0,1], or show that the later same-day basket OHLCV denominator does not remove the reproduced current-session violations.
