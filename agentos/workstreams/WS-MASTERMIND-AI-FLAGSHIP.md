---
key: MASTERMIND-AI-FLAGSHIP
title: Mastermind AI flagship investigative intelligence
objective: >
  Turn the existing Analyst OS into a useful investment-research workspace that
  investigates evidence, computes financial implications, tests competing theses
  and carries an authorized case through the existing thesis and monitor owners.
  Completion requires real customer-path evidence, not source presence or API success.
status: active
...
ambiguity: open
owns_paths:
  - research/mastermind_ai_flagship/
waves:
  - id: D0
  ...
  - id: R1
    ...
    status: todo
    depends_on: [R0]
    next_action: Qualify the smallest search/open adapter with public-only egress and preserve bounded Research compatibility.
  - id: R2
