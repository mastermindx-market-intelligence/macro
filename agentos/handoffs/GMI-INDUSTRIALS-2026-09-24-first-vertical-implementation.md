...
next_actions:
  ...
  - "Then dispatch T05 (payload $K/ext/args_ind_t05_source_history.json is pre-built) on mb once T04 is on main; T05/T06 must consume T04 per rulings_t05.md R6-R7 and rulings_t06.md R7-R8."
