...
next_actions:
  ...
  - >
    Reconcile the externally applied Studio Direct `Nice=5` launchd overlay with its existing host/thermal owner before any private-seat upgrade. Preserve exact plist hashing; do not silently absorb or remove the overlay from this Paper carrier.
  - >
