"""One-shot private consumer for longitudinal Research Intelligence belief deltas."""
...
from engine.research_intelligence.belief_delta import compare_institutional_rio, summary
