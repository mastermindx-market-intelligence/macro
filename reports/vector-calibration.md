...
Span: 2015-01-01..2026-09-12 (4273 days). Split-half boundary: 2021-01-01.
...
| sth_cb_ratio | **EXTREMES — low <-10%: -0.2%/90d 35.4% hit (n=321) [weak]** | 0 | 0 | 0 | 1 |
| hash_ribbon_capit | **CONTEXT-ONLY** | 0 | 0 | 0 | 1 |
| dvol | **EXTREMES — low <40: +5.9%/90d 45.0% hit (n=287) [weak]; high >90: +15.8%/90d 71.4% hit (n=168) [weak]** | 0 | 0 | 0 | -1 |
| vrp | **EXTREMES — low <-5: +17.2%/90d 77.8% hit (n=217) [weak]; high >15: +7.2%/90d 53.9% hit (n=484) [TOP]** | -1 | 0 | -1 | -1 |
| leverage_stress | **EXTREMES — low 0-25: +13.5%/90d 62.3% hit (n=700) [weak]** | -1 | 0 | -1 | -1 |
...
| reserve_risk | **EXTREMES — low <.0015: +16.3%/90d 64.5% hit (n=979) [weak]; high >.02: -42.5%/90d 4.2% hit (n=48) [TOP]** | 1 | 0 | -1 | -1 |
| impulse | **DIRECTIONAL (one half weak)** | 1 | 0 | 1 | 1 |
| cycle_pct | **DIRECTIONAL (one half weak)** | -1 | -1 | 0 | -1 |
| cot_z | **EXTREMES — low <-1.5: +13.2%/90d 47.8% hit (n=224) [weak]; high >1.5: -5.7%/90d 34.2% hit (n=665) [TOP]** | -1 | 0 | -1 | -1 |
| corr_spx | **CONFIRMED** | -1 | -1 | -1 | -1 |
| vdd_multiple | **EXTREMES — low <.5: +6.2%/90d 41.4% hit (n=779) [weak]; high >2.9: +35.2%/90d 59.1% hit (n=154) [weak]** | 1 | 1 | 0 | -1 |
...
| vov_pctile | **EXTREMES — low 0-25: +12.3%/90d 52.6% hit (n=1184) [weak]; high 75-100: +36.6%/90d 73.7% hit (n=843) [weak]** | 1 | 1 | 0 | -1 |
...
|:-------|-----:|-----------:|-----------:|------------:|------------:|------------:|------------:|
| 0-25   | 2106 |      -2.95 |     -14.02 |       -8.15 |      -26.04 |      -13.73 |      -46.56 |
...
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| 0-25   | 2106 |     56.1 |      1.99 |      56.7 |       7.85 |      65.9 |      28.21 |
| 25-50  | 1355 |     53.4 |      0.68 |      57.9 |       5.22 |      51.3 |      16.26 |
| 50-75  |  708 |     54   |      0.71 |      59.3 |       4.5  |      56.8 |      14.48 |
...
| band    |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-0.5   | 1070 |     53.6 |      0.33 |      58.1 |       2.22 |      52.3 |       6.8  |
| -0.5..0 |  692 |     51.3 |      0.69 |      56.7 |       4.12 |      57.2 |      18.65 |
| 0..0.5  |  789 |     51.5 |      0.68 |      53.8 |       5.6  |      52.9 |      21.83 |
| >0.5    | 1722 |     58.3 |      2.58 |      59.2 |      10.22 |      68.1 |      32.11 |

### structure — forward returns by band (full sample)

| band         |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| broken       | 1170 |     53.1 |      0.46 |      60.4 |       3.23 |      58   |      12.32 |
| neutral      | 1262 |     54   |      1.03 |      55.8 |       6.29 |      56.2 |      22.01 |
| constructive | 1841 |     56.3 |      2.16 |      56.8 |       8.42 |      63   |      27.66 |

### risk_oscillator — forward returns by band (full sample)

| band    |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| falling | 1707 |     56   |      1.96 |      59.2 |       6.28 |      58   |      21.64 |
| neutral | 1278 |     54.6 |      1.33 |      58.6 |       7.1  |      63   |      24.2  |
| rising  | 1288 |     53.1 |      0.58 |      54.3 |       5.73 |      58.4 |      19.66 |

### bfi — forward returns by band (full sample)

| band   |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <40    | 1615 |     51   |      0.5  |      53.2 |       3.59 |      49.7 |      13.13 |
| 40-60  | 1069 |     55   |      0.72 |      57.8 |       7.06 |      61.4 |      22.06 |
| >60    | 1514 |     58.5 |      2.8  |      62.3 |       9.1  |      69.9 |      32.19 |
...
| 0-1    | 1286 |     53.9 |      1.04 |      57.5 |       4.1  |      49.1 |       4.34 |
...
| 0-.25  |  684 |     57.9 |      1.94 |      68.7 |       7.29 |      57   |      10.18 |
| .25-.5 | 1694 |     52.9 |      0.73 |      52.9 |       2.59 |      59.3 |      16.12 |
...
| band    |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <0.8    |  633 |     54.7 |      1.01 |      62.2 |       4.12 |      48.5 |      11.38 |
| 0.8-1   | 1006 |     51.6 |      0.1  |      54.2 |       2.35 |      51.6 |      10.17 |
| 1-1.5   | 1913 |     55.7 |      1.46 |      57.9 |       6.15 |      68.3 |      24.11 |
...
| 0.5-1  | 1765 |     54.2 |      0.71 |      59.4 |       4.34 |      60.8 |      19.83 |
| 1-2    | 1862 |     55.1 |      1.69 |      55.6 |       6.87 |      60.1 |      20.23 |
...
| band   |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-10%  | 321 |     53.9 |      0.6  |      60.4 |       1.89 |      35.4 |      -0.18 |
| -10-0% | 390 |     52.3 |      0.33 |      59.2 |       3.4  |      68   |      21.3  |
| 0-20%  | 646 |     53.2 |      1.17 |      52.5 |       4.5  |      57.5 |       8.63 |
...
| band         |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| normal       | 3463 |     55.1 |      1.56 |      58.3 |       7.18 |      60.1 |      23.22 |
| capitulation |  810 |     53.2 |      0.49 |      54.4 |       2.82 |      57.3 |      15.17 |

### dvol — forward returns by band (full sample)

| band   |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <40    | 287 |     50.7 |      0    |      47.4 |       1.12 |      45   |       5.86 |
| 40-55  | 664 |     51.8 |      0.95 |      59.7 |       4.42 |      61.2 |      11.31 |
...
| band   |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-5    | 217 |     57.6 |      0.99 |      61.6 |       3.81 |      77.8 |      17.23 |
| -5-0   | 175 |     57.7 |      1.61 |      64.1 |       5.36 |      49.4 |       8.52 |
| 0-5    | 381 |     50.1 |      0.19 |      55.2 |       2.47 |      34   |       0.6  |
| 5-15   | 742 |     47.3 |     -0.23 |      47.6 |       0.1  |      51.8 |       3.75 |
...
| band   |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| 0-25   | 700 |     54   |      1.3  |      58.8 |       4.05 |      62.3 |      13.46 |
| 25-50  | 474 |     51.8 |      0.2  |      55.9 |       3.24 |      58.7 |      11.97 |
| 50-75  | 348 |     52.9 |      0.77 |      50.7 |       2.9  |      45.5 |       3.24 |
...
| band   |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-1    |   5 |     66.7 |     -0.18 |       nan |        nan |       nan |        nan |
| -1-0   |   2 |      0   |     -3.1  |       nan |        nan |       nan |        nan |
| 0-1    |   5 |     50   |     -1.19 |       nan |        nan |       nan |        nan |
| 1-2    |   3 |    100   |      1.36 |       nan |        nan |       nan |        nan |
...
| band   |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-10%  | 166 |     59   |      1.03 |      58.5 |       0.82 |      70.4 |      14.78 |
| -10-0% | 550 |     53   |      1.25 |      59.7 |       4.89 |      61.9 |      12.64 |
| 0-10%  | 665 |     52.8 |      0.73 |      54   |       3.84 |      53.1 |       9.01 |
...
| band   |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-2%   | 1256 |     52.2 |      0.58 |      53.4 |       1.6  |      48.8 |       8.69 |
| -2-0%  |  890 |     53.8 |      1.54 |      56.8 |       7.62 |      61.6 |      17.93 |
| 0-2%   |  870 |     53   |      1.14 |      57.5 |       5.42 |      61.5 |      21.69 |
...
| -.1-.1 | 997 |     58.2 |      2.01 |      60.3 |       8.27 |      56.2 |      19.48 |
| .1-.3  | 966 |     54.2 |      1.62 |      58.6 |       7.51 |      61.3 |      17.48 |
...
| -.3-0  | 1035 |     51.4 |      0.33 |      52.9 |       2.33 |      44.4 |       5.07 |
| 0-.5   | 1883 |     52.6 |      0.98 |      52.8 |       4.18 |      55.5 |      13.41 |
...
| -.3-.5 |  539 |     55.1 |      1.27 |      47.9 |       0.8  |      47.3 |       3.5  |
| .5-1.5 | 1440 |     52.4 |      0.72 |      52.4 |       3.78 |      53.4 |      21.18 |
...
| band    |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <0.7    | 414 |     51.1 |      0.48 |      58.1 |       1.96 |      49.4 |       4.5  |
...
| -.75--.25 | 143 |     51   |      0.02 |      54.5 |       0.16 |      44.3 |       1.13 |
| -.25-.25  | 167 |     49.1 |      0.67 |      58   |       2.59 |      43.2 |       2.81 |
| .25-.75   | 123 |     65.9 |      1.7  |      63.9 |       5.89 |      57   |       8.77 |
| >.75      | 187 |     53.2 |      1.02 |      59.9 |       5.17 |      59.9 |       6.55 |

### reserve_risk — forward returns by band (full sample)

| band        |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:------------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <.0015      |  979 |     55.8 |      1.47 |      61.8 |       5.67 |      64.5 |      16.26 |
...
| band     |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:---------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-.5     |  376 |     55.9 |      1.52 |      51.3 |       4.42 |      60.9 |      22.87 |
| -.5--.15 |  610 |     52.4 |      0.57 |      56.5 |       6.87 |      59.9 |      19.44 |
| -.15-.15 | 2084 |     52.4 |      0.63 |      55.5 |       4.69 |      57.1 |      17.8  |
...
| markdown | 1336 |     49.1 |     -0.37 |      49.5 |      -0.45 |      41.4 |       4.24 |
...
| -.5-.5   | 749 |     56.2 |      1.32 |      53.9 |       3.98 |      61.6 |      18.82 |
| .5-1.5   | 604 |     47.6 |      0.13 |      48.8 |       1.5  |      53.5 |       9.38 |
| >1.5     | 665 |     46.2 |     -0.7  |      47.7 |      -2.2  |      34.2 |      -5.73 |
...
| .2-.4  | 1088 |     53.8 |      0.76 |      51   |       2.45 |      56.5 |      11.02 |
| >.4    |  943 |     50.8 |      0.53 |      56.5 |       2.67 |      48.7 |      11.19 |

### vdd_multiple — forward returns by band (full sample)

| band    |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <.5     |  779 |     55.2 |      0.5  |      53.8 |       2.75 |      41.4 |       6.25 |
...
| 5.5-7  | 1350 |     53.8 |      1.01 |      54.6 |       3.55 |      47.1 |       6.68 |
...
| band   |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| 0-25   | 1252 |     55.1 |      1.28 |      59.7 |       5.77 |      70   |      24.1  |
| 25-50  | 1077 |     53   |      0.73 |      50.2 |       2.31 |      50.1 |      15.39 |
| 50-75  |  917 |     56.4 |      1.43 |      57.6 |       8.14 |      55.1 |      23.16 |
...
| band   |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| 0-25   | 1184 |     55.4 |      1.36 |      52.8 |       3.71 |      52.6 |      12.32 |
| 25-50  | 1022 |     53.1 |      0.96 |      56.3 |       6.47 |      55.3 |      19.27 |
| 50-75  |  999 |     54.3 |      1.55 |      60.2 |       6.56 |      62.4 |      27.58 |
| 75-100 |  843 |     56.9 |      2.01 |      64.4 |      11.4  |      73.7 |      36.6  |

### stbl_growth_z — forward returns by band (full sample)

| band   |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-1    |  419 |     44.6 |     -1.05 |      43.9 |      -2.03 |      44.1 |       1.55 |
| -1-0   | 1588 |     53.4 |      1.04 |      54.3 |       4.41 |      53.4 |      15.87 |
| 0-1    |  634 |     49.6 |      0.82 |      51.1 |       4.01 |      55.8 |      16.26 |
...
|:-------------|-------:|-------------:|---------------:|------------:|---------:|--------------:|----------:|---------------:|--------:|-------------:|-----------------:|------------------:|----------------:|
| conservative |   50.1 |         52.6 |            2.5 |        60.1 |     1.37 |          1.04 |      1.5  |           1.39 |   -33.6 |        -83.8 |             62.7 |              16.6 |            0.47 |
| moderate     |   62.4 |         65   |            2.6 |        60.1 |     1.43 |          1.04 |      1.76 |           1.39 |   -37.1 |        -83.8 |             80.2 |              16.1 |            1.18 |
| aggressive   |   61.5 |         64   |            2.5 |        60.1 |     1.31 |          1.04 |      1.63 |           1.39 |   -45.2 |        -83.8 |             85   |              15.6 |            1.1  |
| optimal      |   61   |         63.6 |            2.6 |        60.1 |     1.41 |          1.04 |      1.74 |           1.39 |   -41.2 |        -83.8 |             81.4 |              16.1 |            1.07 |
...
**Block-bootstrap 95% CI** [optimal, 5000 resamples, 21d blocks]: Sharpe **1.4** [0.78, 2.01] · MaxDD -45.1% [-32.2, -66.6] · P(Sharpe>0) 1.0. Circular block bootstrap (21d blocks) of the NET daily strategy returns → 95% CI [2.5, 50, 97.5]. sharpe_gt0_prob = bootstrap P(Sharpe>0). Pairs with the Deflated-Sharpe haircut: DSR deflates the mean, this bounds the variance.
...
OOF 7d direction: **Brier 0.2489** vs base 0.2476 (skill -0.005); Platt a=0.757, b=0.057. Out-of-fold: each day's P(up) is the momentum×risk cell rate fit on the OTHER folds (EB-shrunk, the live mechanism), scored vs realized. brier<base_brier = skill; Platt a≈1/b≈0 = already calibrated. Direction is a near-coin-flip, so calibrated probabilities cluster near the base rate — that is the honest result.

| prob bin | n | predicted | observed |
|---|--:|--:|--:|
| 0.5-0.6 | 3817 | 0.546 | 0.55 |
...
- DSR (gated) — P(true Sharpe > 0): **0.9602**
- Observed Sharpe 1.41 ann (0.07364/day); haircut threshold SR0 0.81 ann
- N=71 trials (upper-bound, incl. override dof_cost) · T=4273d · skew=0.61 · kurt=13.238 · SR-variance: max(cross-variant dispersion, null SR-sampling proxy)
- **Effective-N haircut**: T_eff=2543.6 vs raw T=4273 (rho_sum_K20=0.34); dsr_effN=0.9129 (dsr_legacy=0.9933). Block-bootstrap refinement: W5.
...
- DSR (raw) — P(true Sharpe > 0): **0.9602**
- Observed Sharpe 1.41 ann; SR0 0.81 ann
- N=71 trials · T=4273d · skew=0.61 · kurt=13.238
- **Effective-N haircut**: T_eff=2543.6, dsr_effN=0.9129 (dsr_legacy=0.9933)
...
As-of 2026-09-12: **n_trials_declared=71** = n_trials_config=65 (config upper-bound) + override dof_cost (registry).
...
|---|--:|--:|--:|
| ensemble_eqw | 1.27 | 1.46 | 0.62 |
| best_single | 0.98 | 1.2 | 0.43 |
| heuristic | 1.19 | 1.48 | 0.69 |

Ensemble OOF rank-IC vs 90d return: **0.186** (best single axis = `net_liq_roc`). Per-axis IC: risk_index 0.08, net_liq_roc 0.252, vrp nan, cot_z 0.004, mvrv_z 0.067, momentum 0.127.
