...
|---|---|---|--:|---|---|--:|
| recession (Recession-risk composite (0-100)) | **DIRECTIONAL** | 0.149/0.18/0.04 | 0.507 | 0.22 vs 0.122 (+9.8pp) | 1967-06-01..2026-06-16 | 15404 |
| drawdown (Drawdown-risk gauge (0-100, already MEASURED)) | **CONFIRMED** | 0.224/0.26/0.101 | 0.537 | 0.242 vs 0.124 (+11.8pp) | 1969-07-31..2026-06-16 | 14839 |
| credit (HY-OAS credit stress (0-100)) | **DIRECTIONAL** | 0.18/0.287/-0.07 | 0.286 | 0.287 vs 0.157 (+13.0pp) | 1996-12-31..2026-06-16 | 7686 |
| rates_vol (MOVE rates-vol stress (0-100)) | **CONFIRMED** | 0.167/0.244/0.079 | 0.182 | 0.204 vs 0.131 (+7.3pp) | 2002-11-12..2026-06-16 | 6156 |
| plumbing (SOFR-IORB funding stress (0-100)) | **CONTEXT** | -0.067/nan/-0.067 | None | 0.144 vs 0.14 (+0.4pp) | 2021-07-29..2026-06-16 | 1274 |
| composite (Bond-stress composite = 100 - health score (the headline)) | **CONFIRMED** | 0.207/0.242/0.073 | 0.545 | 0.239 vs 0.122 (+11.7pp) | 1967-06-01..2026-06-16 | 15404 |

## Diagnostic curve signals

| Signal | Verdict | IC dd (full/pre/post) | IC recession | hi-tercile P(dd10) vs base | span | n |
|---|---|---|--:|---|---|--:|
| ny_fed_prob (NY-Fed 3m10y recession probit) | **CONTEXT** | -0.023/-0.005/-0.019 | 0.217 | 0.129 vs 0.119 (+1.0pp) | 1981-09-01..2026-06-16 | 11686 |
| neg_ntfs (Near-term forward spread (sign-flipped: low = stress)) | **CONTEXT** | -0.042/0.054/-0.187 | 0.167 | 0.103 vs 0.119 (-1.6pp) | 1981-09-01..2026-06-16 | 11686 |
| hy_oas (High-yield OAS level (%)) | **DIRECTIONAL** | 0.18/0.288/-0.07 | 0.286 | 0.287 vs 0.157 (+13.0pp) | 1996-12-31..2026-06-16 | 7686 |
