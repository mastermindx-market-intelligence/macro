...
- VM: `scripts/capture_commodities_w6_evidence.fixture_vm` (current-shaped board from `tests/test_commodities_w6_truth.py::test_hero_current_shaped_board_is_selective`: heating oil / corn / soybeans stretched → hero **In favour — 3 of 17 stretched**).
