...
(function () {
  ...
  function laneLabel(lane){var labels={ACT_NOW:['Act now — research','立即研究'],RECONCILE:['Reconcile','先核对'],RESEARCH_NEXT:['Research next','下一步研究'],MONITOR:['Monitor','持续观察']},pair=labels[clean(lane)]||[humanize(lane),humanize(lane)];return tr(pair[0],pair[1])}
