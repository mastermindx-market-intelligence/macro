"""Pin packet W9B_REC_F13: the F13 slice of LEDGER_MOVES exists as a note, and
...
`research/market_intelligence_productization/W9_LEDGER_NOTE_F13_2026-09-13.md`:
...
`missing W9 F13 ledger note: <path>`.
"""
...
NOTE = _ROOT / (
    ...
    "W9_LEDGER_NOTE_F13_2026-09-13.md"
)

# The four rows ruling R1 names, in the order the ruling gives them, which is the
# order LEDGER_MOVES #32-#35 carry.
ROWS = ("MO-DELTA-007", "MO-DELTA-011", "MO-PAID-058", "MO-PAID-088")
...
def test_the_w9_f13_ledger_note_carries_every_row_and_says_nothing_forbidden() -> None:
    assert NOTE.exists(), f"missing W9 F13 ledger note: {NOTE}"
