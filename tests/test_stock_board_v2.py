    ...
    (site / "marketdata" / "subsector_confluence.json").write_text(json.dumps({
        "as_of": today, "weighting": "equal", "subsectors": [{
            ...
            "members": [{
                ...
                "stock_eligible": True, "stock_buyable": True,
                "stock_state": "long-bias",
            }],
        }],
    }))
